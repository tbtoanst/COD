...
@Component({
  selector: 'app-transaction-priority',
  templateUrl: './transaction-priority.component.html',
  styleUrls: ['./transaction-priority.component.scss']
})
export class TransactionPriorityComponent implements OnInit {
